<?php
	...
	//si diferente verificaTokenpass con las variables
	if(!verificaTokenPass($user_id, $token))
	{
		echo 'No se pudo verificar los Datos'; //mensaje
		exit;
	}
			...
			<div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
				<div class="card" >
					<div class="card-header">
						<div class="card-title">Cambiar Password</div>
						<div style="float:right; font-size: 80%; position: relative; top:-10px"><a href="index.php">Iniciar Sesi&oacute;n</a></div>
					</div>     
					
					<div style="padding-top:30px" class="card-body" >
						
						<form id="loginform" class="form-horizontal" role="form" action="guarda_pass" method="POST" autocomplete="off">
