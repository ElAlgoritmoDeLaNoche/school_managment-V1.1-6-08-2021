<?php
	...
	$row = $result->fetch_assoc(); //guardar los datos
  ...
  if (isset($_POST['submit'])) { // 
    if(is_uploaded_file($_FILES['fichero']['tmp_name'])){
      ...
      if (move_uploaded_file($_FILES['fichero']['tmp_name'], $upload)) {
        ...
        $nombre  = $_POST["nombre"];  //obtener el valor de la variable nombre
        $description  = $_POST["description"];  //obtener el valor de la variable description
        $final = $_FILES['fichero']['type']; //obtener el valor de la variable type
        $tamaño = $_FILES['fichero']['size']; //obtener el valor de la variable size

        $query = "INSERT INTO biblioteca_general (nombre, descripcion, ruta, tipo, size) 
        VALUES ('$nombre','$description','".$nombreFinal."','".$final."','".$tamaño."')"; //sentencia SQL
        
        mysqli_query($mysqli, $query) or die(mysql_error()); //acceso a la base de datos, ejecucion de la sentencia
