<?php
  ...
  $errors = array(); //array
    ...
    $tamaño = $mysqli->real_escape_string($_FILES['fichero']['size']);  
		...
		$tipo_usuario = 3; //creacion de una variable
		...
		if(count($errors) == 0){ //si al contar los errors son igual a 0
            ...
            if(is_uploaded_file($_FILES['fichero']['tmp_name'])){
              ...
              echo "Para terminar el proceso de registro indique al profesor que verifique el email enviado a: $email"; //mensaje
...
<?php 
  $consultar = "SELECT * FROM usuarios WHERE id_tipo = 3"; //sentencia SQL
                    ...
                    <div class="tab-content no-padding" id="myTab2Content">
                      <div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                        ...
                        <form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <input type="submit" class="btn btn-primary btn-lg btn-block" id="btn-signup" value="Registrar profesor">
                          </div>
                                    ...
                                    <table class="table table-bordered table-md v_center">
                                      <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <?php echo $row['correo'] ?><!--imprimir lo que tenga la variable correo -->
                                            </td>
                                          <td>
