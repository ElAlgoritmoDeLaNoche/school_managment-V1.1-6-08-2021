                        ...
                        <form action="add" method="post">
                          <div class="card-body">
                            <div class="form-group">
                              <label>
                                Ingresa el nombre de la clase según (ejemplo Español)
                              </label>
                              <input type="text" class="form-control"
                                placeholder="Ingresa el nombre del nivel corresponde (ejemplo primaria)" name="clase">
                            </div>
                            <div class="form-group">
