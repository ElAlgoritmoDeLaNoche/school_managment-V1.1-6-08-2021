<?php
  ...
  $admins = "SELECT id_tipo FROM usuarios WHERE id_tipo = 2"; //sentencia SQL
  $query_run = mysqli_query($mysqli, $admins); //se ejecuta la sentencia
  $admin = mysqli_num_rows($query_run); //visualizan los datos
        ...
        <section class="section">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="card card-statistic-2">
                <div class="card-stats">
                  <div class="card-stats-title">Numero de administradores - </div>
                </div>
                <div class="card-icon shadow-primary bg-primary">
                  <i class="fas fa-archive" style="color: #f3f3f3"></i>
                </div>
