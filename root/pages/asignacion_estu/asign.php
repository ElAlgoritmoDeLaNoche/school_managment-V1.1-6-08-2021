<?php
  ...
  $usuario = mysqli_query($mysqli, "SELECT * FROM usuarios WHERE id_tipo = 4"); //sentencia SQL
          ...
          <div class="col-12 col-sm-12 col-lg-12">
            <div class="card">
              <div class="card-header">
                <h4>Asignar alumnos a grupos</h4>
              </div>
              <div class="card-body">
                <form action="add" method="post">

                  <div class="section-title mt-0">Selecciona al alumno</div>
