<?php
  ...
  $est = $mysqli->query($estudiante); //ejecucion de la sentencia
        ...
        <section class="section">
          <div class="card">
            <div class="card-header">
              ...
              <h4>Tareas o actividades</h4>
              <?php elseif($grupo == null): ?><!--de lo contrario y lo que tenga la variable grupo es igual a null -->
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped v_center">
                        ...
                        <tbody>
                        <?php 
                          while($actividades = mysqli_fetch_array($a)){
