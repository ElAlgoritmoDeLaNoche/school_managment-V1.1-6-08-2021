          ...
          <div class="card">
            <div class="card-header">
              <?php 
                ...
                $grupo = $fila['grupo_estu']; //variable
            ...
            <div class="card-body">
              <?php foreach($get as $q){?>
                <div class="bg-dark p-5 rounded-lg text-white text-center">
                  <h1><?php echo $q['title'];?></h1><!--imprime lo que tenga la variable title -->
                </div>
                  <p class="mt-5 border-left border-dark pl-3"><?php echo $q['content'];?></p><!--imprime lo que tenga la variable q -->
                <?php } ?>
