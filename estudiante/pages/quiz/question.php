<?php
	...
	require '../../funcs/funcs.php';//incluir el archivo
          ...
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
              ...
              <div class="d-sm-none d-lg-inline-block">
                Hola, <?php echo $row['nombre']; ?> <!--imprimir lo que tenga la variable nombre -->
              </div>
            </a>
            <!--submenu -->
                  ...
                  <div class="col-12 col-sm-12 col-md-12">
                    <div class="tab-content no-padding" id="myTab2Content">
                      ...
                      <div class="card-body">
												<main>
													<div class="container">
														<div class="current">Pregunta <?php echo $number; ?> de <?php echo $total_questions; ?> </div> <!--imprime lo que tenga la variable number y total_questions -->
														<p class="question"><?php echo $question['question_text']; ?> </p><!--imprimir lo que tenga la variable question:question_text -->
														<form method="POST" action="process.php">
															<ul class="choicess">
																<?php while($row=mysqli_fetch_assoc($choices)){ ?>
																<li><input type="radio" name="choice" value="<?php echo $row['id']; ?>"> <?php echo $row['coption']; ?></li><!-- imprime lo que tenga la variable row:id y row:coption -->
																<?php } ?>
															</ul>
															<input type="hidden" name="number" value="<?php echo $number; ?>"><!--link a redireccionamiento e imprime lo que tenga la variable number-->
