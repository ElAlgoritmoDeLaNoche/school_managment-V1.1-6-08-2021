        ...
        <section class="section">
          <div class="card">
            <div class="card-header">
              ...
              <h4>Temario para el grupo <?php echo $grupo ?></h4><!--imprime lo que tenga la variable grupo -->
            ...
            <div class="card-body">
              ...
              <div class="text-center">
                <a href="create" class="btn btn-outline-dark">Crear nuevo temario</a>
              </div>
              ...
              <div class="row">
                ...
                <?php foreach($queryb as $q){ ?>
                  ...
                  ?>
                <?php if($grupo_d == $nivel): ?><!--lo que tenga la variable grupo es igual a lo que tenga la variable nivel -->
