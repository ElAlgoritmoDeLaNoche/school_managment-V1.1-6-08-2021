<?php
  ...
  if(isset($_REQUEST['delete'])){
    ...
    $sql = "DELETE FROM temario WHERE id = $id"; //sentencia SQL
              ...
              ?>
                <div class="bg-dark p-5 rounded-lg text-white text-center">
                  ...
                  <div class="d-flex mt-2 justify-content-center align-items-center">
                    <a href="edit.php?id=<?php echo $q['id']?>" class="btn btn-light btn-sm" name="edit">Editar</a><!--imprime lo que  tenga la variable q:id -->
                    <form method="POST">
                      <input type="text" hidden value='<?php echo $q['id']?>' name="id"><!--imprime lo que tenga la variable q:id -->
