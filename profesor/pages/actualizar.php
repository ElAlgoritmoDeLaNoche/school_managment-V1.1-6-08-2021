                          ...
                          <div class="table-responsive">
                            <table class="table table-bordered table-md v_center">
                              <tbody>
                                ...
                                ?>
                                  <tr>
                                    <td><?php echo $row['id'] ?></td> <!--imprime lo que tenga la variable row:id -->
                                    <input 
                                      type="hidden" 
                                      value="<?php echo $row['id'] ?>" 
                                      name="id"
                                    ><!--imprime lo que tenga la variable row:id -->
                                    <td>
                                      <input 
                                        type="text"
                                        value="<?php echo $row['nombre'] ?>"
                                        name="nombre"
                                      ><!--imprime lo que tenga la variable row:nombre -->
                                    </td>
                                    <td>
                                      <input 
                                        type="text"
                                        ...
                                        name="usuario"
                                      ><!--imprime lo que tenga la variable row:usuario -->
                                    </td>
                                    <td>
                                      <input 
                                        type="text"
                                        ...
                                        name="email"
                                      ><!--imprime lo que tenga la variable row:correo -->
                                    </td>
                                  </tr>
                                </tbody>
                              <?php } ?>
