<?php
  ...
  if(isset($_REQUEST['new_post'])){
    ...
    $blog = "INSERT INTO blog(title, content, nivel) VALUES('$title', '$content', '$grupo_d')"; //sentencia SQL
    mysqli_query($mysqli, $blog); //acceder a la base de datos y ejecutar la sentencia

    echo $blog; //mensaje

    header("Location: feedback.php?info=added"); //redireccionamiento a feedback.php
    exit();
  }
