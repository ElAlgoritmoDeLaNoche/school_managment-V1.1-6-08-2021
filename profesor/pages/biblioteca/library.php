<?php
	...
	$idUsuario = $_SESSION['id_usuario']; //obtener lo que tenga la varible id_usuario
	
	$sql = "SELECT id, nombre FROM usuarios WHERE id = '$idUsuario'"; //sentencia SQL
	$result = $mysqli->query($sql); //ejecucion de la sentencia
	
	$row = $result->fetch_assoc(); //visualizacion de la informacion 

  $library = "SELECT * FROM biblioteca_general"; //sentencia SQL
  $res = mysqli_query($mysqli, $library); //acceder a la base de datos y ejecutar la sentencia
  $files = mysqli_fetch_all($res, MYSQLI_ASSOC); ////visualizacion de la informacion 

  if(isset($_GET['id'])){ //se obtiene lo que tenga la variable id
    $id = $_GET['id'];//se obtiene lo que tenga la variable id
    $lib = "SELECT * FROM biblioteca_general WHERE id = '$id'"; //sentencia SQL
    $ress = mysqli_query($mysqli, $lib); //acceder a la base de datos y ejecutar la sentencia
    $file = mysqli_fetch_assoc($ress); //visualizacion de la informacion
    $filepath = '../../../upload/'.$file['ruta']; //creacion

    if(file_exists($filepath)){ //si existe el file_exists va obtener una variable
                                  ...
                                  <table>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                        <!--link que redirecciona a library.php -->
