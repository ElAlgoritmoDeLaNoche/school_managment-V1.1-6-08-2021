  ...
  if (isset($_POST['submit'])) {
    if(is_uploaded_file($_FILES['fichero']['tmp_name'])){
      ...
      if (move_uploaded_file($_FILES['fichero']['tmp_name'], $upload)) {
        ...
        $nombre  = $_POST["nombre"];  //creacion de una variable
        $description  = $_POST["description"];  //creacion de una variable
        $final = $_FILES['fichero']['type']; //creacion de una variable
        $tamaño = $_FILES['fichero']['size']; //creacion de una variable
        ...
        mysqli_query($mysqli, $query) or die(mysql_error()); //funcion para ver si no hay errores al acceder a la base de datos
