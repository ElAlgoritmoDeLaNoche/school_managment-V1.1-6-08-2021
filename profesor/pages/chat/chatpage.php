<?php
  ...
  $chat = "SELECT * FROM chat"; //sentencia SQL
  $queryb = mysqli_query($mysqli, $chat); //acceder a la base de datos y ejecutar la sentencia
        ...
        <section class="section">
          <div class="card">
            <div class="card-header">
              ...
              ?>
              <?php if($carpeta == $grupo_d): ?><!--si lo que tenga la variable carpeta es igual a lo que tenga la variable grupo -->
            ...
            <div class="card-body">
              ...
              ?>
                <?php if($grupo_d == $nivel): ?> <!--si lo que tenga la variable grupo_d es igual a lo que tenga nivel -->
                  <div id="chat"></div>
                <?php endif; ?>
              <?php }?>
              </div>
