<?php
  ...
  $profesor = "SELECT DISTINCT usuarios.nombre, asignacion.id, asignacion.nom_prof, asignacion.nivel, asignacion.grupo, asignacion.clase FROM `usuarios` INNER JOIN asignacion ON usuarios.nombre = asignacion.nom_prof WHERE nom_prof = '$NomSes' "; //sentencia SQL
                            ...
                            <div class="col-12 col-md-12 col-lg-12">
                              <div class="card">
                                  <table>
                                    ...
                                    <tbody>
                                    <?php foreach($query as $clases) {
                                      $id = $clases['id']; //variable
                                      $nivel = $clases['nivel']; //variable
                                      $grupo = $clases['grupo']; //variable
                                      $clase = $clases['clase']; //variable
                                    ...
                                    <?php if($carpeta == $grupo_d): ?> <!--si lo que tenga la variable carpeta es igual a lo que tenga la variable grupo_d -->
                                      <tr>
                                        <!--<td><?php echo $id; ?></td>--><!--imprimir lo que tenga la variable id -->
                                        <td><?php echo $nivel; ?></td><!--imprimir lo que tenga la variable nivel -->
                                        <td><?php echo $grupo; ?></td><!--imprimir lo que tenga la variable grupo -->
                                        <td><?php echo $clase; ?></td><!--imprimir lo que tenga la variable clase  -->
                                      </tr>
                                      <?php endif; ?>
                                      <?php } ?>
                                    </tbody>
